...
print(Fore.YELLOW, 'd = ', Fore.RED + f'{chaves.e}', Style.RESET_ALL)
print(Fore.YELLOW, 'n = ', Fore.BLUE + f'{chavePublica.n}', Style.RESET_ALL, '\n')
pemChavePrivada = chaves.exportKey()
print(pemChavePrivada.decode('ascii', '\n'))

print(Fore.MAGENTA, '================== VALIDANDO PARAMETROS ==================', '\n')
...
print(Fore.MAGENTA, '================== CRIPTOGRAFAR ==================', '\n')
...
print(Fore.MAGENTA, '================== DESCRIPTOGRAFAR ==================', '\n')
